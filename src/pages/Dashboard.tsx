      ...
      <div className="page-content">
        ...
        <div className="grid grid-cols-12 gap-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 onClick={() => navigate(`/${p.slug}/editor`)} className="font-body text-5xl mb-4 italic text-on-surface leading-tight max-w-md cursor-pointer hover:text-primary">
                      {p.title}
                    </h3>
                  ...
                  <div className="relative z-10 mt-12 cursor-pointer" onClick={() => navigate(`/${p.slug}/editor`)}>
                    <div className="flex justify-between mb-3 items-end">
                      ...
                      <span className="font-body text-2xl text-primary italic">{words.toLocaleString()} words</span>
                    </div>
          ...
          <motion.div
            ...
            className="col-span-12 lg:col-span-4 bg-surface-container-low rounded-[2rem] p-8 border border-outline-variant/10"
          >
            <h4 className="font-headline text-[10px] uppercase tracking-[0.2em] text-slate-500 mb-6">Weekly Rhythm</h4>
            <div className="flex items-end gap-2 h-32 mb-6">
              {weeklyBars.map((h, i) => (
                <div key={i} className="flex-1 bg-surface-container-high rounded-t-lg group relative" style={{ height: `${h}%` }}>
                  <div className="absolute inset-0 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg" />
                  {i === 3 && (
                    <div className="absolute inset-0 bg-primary opacity-50 rounded-t-lg" />
                  )}
                </div>
              ))}
            </div>
            <div className="flex justify-between items-center">
              <span className="text-xs font-headline text-on-surface-variant italic">Steady flow this week</span>
