    ...
    <div className="page-shell">
      ...
      <div className="page-content">
        <div className="max-w-7xl mx-auto">
          {/* Hero Header */}
          <div className="mb-12">
            <h2 className="font-body text-5xl text-[#dae2fd] mb-2">Editorial Pulse</h2>
          ...
          <div className="grid grid-cols-12 gap-8">
            ...
            <motion.div
              ...
              className="col-span-12 lg:col-span-4 bg-[#131b2e] p-8 rounded-xl relative overflow-hidden group"
            >
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <p className="text-xs font-label text-slate-500 uppercase tracking-widest mb-1">Daily Target</p>
                    <p className="font-body text-4xl font-light text-[#dae2fd]">1,248 / 2,000</p>
                  </div>
                  <div className="bg-[#4ade80]/10 text-[#4ade80] px-3 py-1 rounded-full text-xs font-bold">62%</div>
                </div>
                <div className="w-full h-2 bg-[#222a3d] rounded-full overflow-hidden mb-4">
                  <motion.div
            ...
            <motion.div
              ...
              className="col-span-12 lg:col-span-4 bg-[#131b2e] p-8 rounded-xl flex flex-col justify-between"
            >
              <div className="flex items-center gap-3 mb-6">
                <span className="material-symbols-outlined text-[#ffb783] text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>local_fire_department</span>
                <p className="font-body text-3xl text-[#dae2fd]">14 Day Streak</p>
              </div>
                ...
                {weekDays.map((d, i) => (
                  <div key={i} className="flex flex-col items-center">
                    <div
                      ...
                      style={{ height: streakBars[i] ? `${streakBars[i] * 4}px` : '8px', background: streakBars[i] ? '#4ade80' : '#222a3d' }}
                    />
            ...
            <motion.div
              ...
              className="col-span-12 lg:col-span-4 bg-[#131b2e] p-8 rounded-xl"
            >
            ...
            <div className="col-span-12 lg:col-span-8 flex flex-col gap-8">
              <motion.div
                ...
                className="bg-[#171f33] rounded-xl p-10 border border-[#464554]/10"
              >
                <h3 className="font-body text-3xl mb-8 text-[#dae2fd]">Creative Velocity</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {velocityStats.map(stat => (
                    <div key={stat.label} className="space-y-1">
                      ...
                      <p className={`font-body text-2xl ${stat.green ? 'text-[#4ade80]' : 'text-[#dae2fd]'}`}>{stat.value}</p>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              >
                <img
                  ...
                  alt="Writing setup"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b1326] to-transparent opacity-80" />
                <div className="absolute bottom-8 left-8 right-8">
                  <p className="font-label text-xs text-[#c0c1ff] mb-2">CHAPTER VII IN PROGRESS</p>
            ...
            <div className="col-span-12 lg:col-span-4 space-y-6">
              <motion.div
                ...
                className="bg-[#131b2e] p-8 rounded-xl"
              >
                <div className="flex items-center justify-between mb-8">
                  <h3 className="font-label font-bold text-sm tracking-widest uppercase text-[#dae2fd]">Version History</h3>
                  <span className="material-symbols-outlined text-slate-500 cursor-pointer hover:text-[#c0c1ff] transition-colors">history</span>
                </div>
                  ...
                  {versionHistory.map((v, i) => (
                    <div key={i} className={`group cursor-pointer ${v.opacity} transition-opacity`}>
                      <div className="flex justify-between items-start mb-2">
                        ...
                        {v.label && <span className="text-[10px] bg-[#c0c1ff]/20 text-[#c0c1ff] px-2 py-0.5 rounded-full">{v.label}</span>}
                      </div>
                      <p className="font-body text-lg group-hover:text-[#c0c1ff] transition-colors text-[#dae2fd]">{v.title}</p>
                      <p className="text-xs text-slate-500 mt-1">{v.delta}</p>
                    </div>
                  ))}
                </div>
                <button className="w-full mt-8 py-3 rounded-lg border border-[#464554]/30 text-xs font-label uppercase tracking-widest text-slate-400 hover:bg-[#222a3d] transition-all">
                  View All Archive
                </button>
              </motion.div>
              ...
              <div className="flex flex-wrap gap-3">
                <div className="bg-[#4f319c] text-[#bea8ff] px-4 py-2 rounded-full text-xs font-medium flex items-center gap-2 cursor-pointer">
                  <span className="material-symbols-outlined text-sm">compare</span>
                  <span>Compare Drafts</span>
                </div>
                <div className="bg-[#222a3d] text-[#c7c4d7] px-4 py-2 rounded-full text-xs font-medium flex items-center gap-2 cursor-pointer hover:bg-[#2d3449] transition-colors">
          ...
          <div className="mt-20 p-1 rounded-2xl" style={{ background: 'linear-gradient(to right, rgba(192,193,255,0.2), transparent, rgba(255,183,131,0.2))' }}>
            <div className="bg-[#060e20] rounded-[calc(1rem-2px)] p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                <div className="p-4 bg-[#171f33] rounded-xl">
                  <span className="material-symbols-outlined text-[#c0c1ff] text-3xl">shutter_speed</span>
                </div>
                <div>
                  <h4 className="font-body text-2xl text-[#dae2fd]">Ready for a sprint?</h4>
                  <p className="text-slate-500 text-sm font-label">The AI editor has identified your most productive hours start now.</p>
                </div>
              </div>
              <button className="bg-[#2d3449] text-[#c0c1ff] font-bold px-8 py-4 rounded-xl backdrop-blur-xl border border-[#c0c1ff]/10 hover:border-[#c0c1ff]/40 transition-all flex items-center gap-3">
